...
# devcontainer / Codespaces "attaching" log renders ANSI codes.
GREEN="\033[0;32m"
RED="\033[0;31m"
BOLD="\033[1m"
RESET="\033[0m"
...
main_install() {
  say "Installing OAI-compatible Copilot extension"
...
printf "%b\n==> [post-attach] complete — Copilot extension is installed.%b\n" "${BOLD}${GREEN}" "${RESET}"
